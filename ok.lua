...
local about = UITab1:section("『国歌』",true)
...
local about = UITab2:section("『音乐』",true)
...
about:Button("skulls",function()
    local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://15689458996"
    sound.Parent = game.Workspace
    sound:Play()
    end)
...
about:Button("hours",function()
    local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://16662829387"
    sound.Parent = game.Workspace
    sound:Play()
    end)
...
about:Button("Murder",function()
    local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://15689453166"
    sound.Parent = game.Workspace
    sound:Play()
    end)
