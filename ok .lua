...
local UITab65 = win:Tab("无名射手",'16060333448')

local about = UITab65:section("『无名射手』",true)

about:Button("找的",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/R1nn1/MainMenu1/main/MainMenuV1.2"))()
end)

local UITab66 = win:Tab("压力",'16060333448')

local about = UITab66:section("压力",true)
