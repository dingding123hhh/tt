game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『旋转』"; Text ="欢迎使用超级旋转"; Duration = 3; })
...
TitleTextShadow.Text = "『旋转』 "..version
